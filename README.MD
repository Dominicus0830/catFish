...
## 디펜던시 - Dependencies
```gradle
implementation 'com.github.Dominicus0830:catFish:0.0.0.8'
```
...
#### [New Inventory System](https://wiki.ryseinventory.de/).

#### [Item Builder](https://github.com/atozuser0224/ItemBuilder)